...
namespace bt9
{
    ...
    public:
        ...
        BT9BranchInstance(const BT9ReaderNodeRecord *src_node_ptr,
                          ...
                          const BT9ReaderEdgeRecord *edge_ptr) : src_node_rec_ptr_(src_node_ptr),
        ...
        /// Copy constructor
        BT9BranchInstance(const BT9BranchInstance &rhs) : src_node_rec_ptr_(rhs.src_node_rec_ptr_),
    ...
    public:
        ...
        BT9Reader(const std::string &name,
                  const uint64_t &buffer_size = 1024) : node_table(this),
                                                        edge_table(this),
        ...
        public:
             ...
             */
            NodeTableIterator(const BT9Reader *rd, const uint32_t &idx) : bt9_reader_(rd),
                                                                          index_(idx)
            {
            ...
            /// Copy constructor
            NodeTableIterator(const NodeTableIterator &rhs) : bt9_reader_(rhs.bt9_reader_),
                                                              index_(rhs.index_)
            {
                assert(bt9_reader_ != nullptr);
            }
        ...
        public:
             ...
             */
            EdgeTableIterator(const BT9Reader *rd, const uint32_t &idx) : bt9_reader_(rd),
                                                                          index_(idx)
            {
                assert(bt9_reader_ != nullptr);
            }
            ...
            /// Copy constructor
            EdgeTableIterator(const EdgeTableIterator &rhs) : bt9_reader_(rhs.bt9_reader_),
                                                              index_(rhs.index_)
            {
                assert(bt9_reader_ != nullptr);
            }
